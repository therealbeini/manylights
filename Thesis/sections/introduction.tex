...
In this bachelor's thesis we introduce a light sampling technique that improves the rendering speed in scenes with many emitters while still maintaining an comparable quality.
