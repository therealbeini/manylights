...
\section{Importance from a vertex to be shaded}
\label{sec:imp}
...
\begin{algorithm}
	...
	\begin{algorithmic}[1] % The number tells where the line numbering should start
		...
		\State <check if the bounding box of node is behind the vertex>
